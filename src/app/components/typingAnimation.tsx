...
const TypingAnimation: React.FC = () => {
    const messages = ['Creative Fullstack Developer.', 'Freelance Developer Digital', 'Transforming Ideas into Code'];
    ...
    return (
        <span className="text-2xl font-bold text-green-500 dark:text-green-600" onMouseEnter={() => setIsHoverPaused(true)}
